...
Using Cython simplifies the embedding as the declaration is in Cython file
(with all Python features available) and C/C++ side require only registering the module.
